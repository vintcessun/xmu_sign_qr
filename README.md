...
初次学kotlin就改造了一下别人的demo项目（原项目[Chaintech-Network/QRKitComposeMultiplatform](https://github.com/Chaintech-Network/QRKitComposeMultiplatform)）
...
* `imagePickerDialogStyle`: Pass ImagePicker dialog customisation like title, color, icon etc.<br>
